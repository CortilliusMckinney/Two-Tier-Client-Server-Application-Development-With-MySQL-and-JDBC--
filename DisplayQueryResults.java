...
public class DisplayQueryResults extends JFrame 
{
   ...
   {   
        ...
        driverComboBox = new JComboBox(new String[]{"com.mysql.jdbc.Driver"});
        ...
        schemaComboBox = new JComboBox(new String[]{"jdbc:mysql://localhost:3306/project3"});
            ...
            new ActionListener() 
            {
               public void actionPerformed( ActionEvent event )
               {
                    ...
                    catch ( SQLException sqlException ) 
                    {
                        ...
                        JOptionPane.showMessageDialog( null, 
                        sqlException.getMessage(), "Database connection error", 
                        JOptionPane.ERROR_MESSAGE );
                    } // end catch
               } // end actionPerformed
            }  // end ActionListener inner class          
